    ...
    interface ActionIntentDao {
        ...
        @Query("SELECT * FROM intents WHERE urgentReminderTime BETWEEN :startDate AND :endDate")
        ...
        @Query("SELECT * FROM intents WHERE status = :status AND urgentReminderTime BETWEEN :startDate AND :endDate")
        ...
        @Query("SELECT * FROM intents WHERE status != 'fulfilled'")
